...
export const Provide = () => {
  return (
    <section className=" p-8 bg-white py-32">
      <Container>
        <div className="flex flex-col md:flex-row items-center justify-between">

          {/* Text Content */}
          <div className="md:w-1/2 space-y-16">
            <h2 className="text-4xl font-semibold text-gray-800 px-6">We provide...</h2>
            <ul className="space-y-8 px-6">
              ...
              <p className="px-10">We offer access to a variety of additional resources to enhance your experience, including exclusive tools, guides, and support materials designed to help you achieve your goals more effectively.</p>
              <hr />
              <li className="flex items-center space-x-3">
                <div className="w-5 h-5 bg-[#287279] text-white flex items-center justify-center rounded-full">
                  ✓
